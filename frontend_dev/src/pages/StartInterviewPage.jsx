...
const interviewModes = [
  {
    ...
    detail:
      "Generate targeted questions from resume skills, projects, and gaps.",
    icon: ClipboardList,
    tag: "Personalized",
  },
  {
    ...
    detail:
      "Run collaborative interview rounds with panel scoring in real time.",
    icon: Users,
    tag: "Collaborative",
  },
  {
          ...
          <CardContent className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">
                Choose interview mode, validate setup, and launch with
                confidence.
              </p>
            </div>
            <Button size="md">
        ...
        >
          <Card className="overflow-hidden border-slate-300/80 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Pick the interview flow based on resume, panel style, or coding
                depth.
              </CardDescription>
            </CardHeader>
